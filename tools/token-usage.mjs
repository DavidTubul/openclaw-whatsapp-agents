...
const AGENT_NAMES = {
  '-home-davidtobol2580-open-claw-workspace': 'Scotty (job-scout)',
  '-home-davidtobol2580-open-claw-workspace-realestate': 'דיגיט (real-estate)',
  '-home-davidtobol2580-open-claw-workspace-poker': 'דילר (poker)',
  '-home-davidtobol2580-open-claw-workspace-pitzuchim': 'פיצי (nuts CS)',
  '-home-davidtobol2580-open-claw': 'dev session (this repo)',
  '-home-davidtobol2580-Projects': 'dev session (Projects)',
};

function agentName(projectDir) {
  if (AGENT_NAMES[projectDir]) return AGENT_NAMES[projectDir];
  return projectDir.replace(/^-home-davidtobol2580-/, '').replace(/-/g, '/');
}
...
function dayKey(ts) {
  // Calendar day in the agents' timezone.
